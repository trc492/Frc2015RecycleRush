...
public class AutoCrabBinSet implements AutoStrategy
{
    private static final String moduleName = "AutoCrabBinSet";
    private Robot robot;
    ...
    public AutoCrabBinSet (Robot robot, double distance)
    {
        this.robot = robot;
